...
proc is_boundary*(halfedge: MyMeshType_HalfedgeWalker): bool =
  return not halfedge.goFace.handle.isValid

proc is_boundary*(edge: MyMeshType_EdgeWalker): bool =
  for halfedge in edge.circulateHalfedges:
    if halfedge.is_boundary:
      return true
  return false
 
proc is_boundary*(vertex: MyMeshType_VertexWalker): bool =
...
proc is_boundary*(face: MyMeshType_FaceWalker, check_vertex: bool = false): bool =
...
proc is_not_boundary*(face: MyMeshType_FaceWalker, check_vertex: bool = false): bool =
  not is_boundary(face, check_vertex)
proc is_not_boundary*(vertex: MyMeshType_VertexWalker): bool =
  not is_boundary(vertex)
proc is_not_boundary*(edge: MyMeshType_EdgeWalker): bool =
  not is_boundary(edge)
proc is_not_boundary*(halfedge: MyMeshType_HalfedgeWalker): bool =
  not is_boundary(halfedge)

proc calc_face_normal(face: MyMeshType_FaceWalker): type(face.goHalfedge.goToVertex.propPoint) =
...
proc getNormal(face: MyMeshType_FaceWalker) : type(face.goHalfedge.goToVertex.propPoint) =
...
proc is_estimated_feature_edge*(halfedge: MyMeshType_HalfedgeWalker, feature_angle: float): bool =
...
proc is_not_estimated_feature_edge*(halfedge: MyMeshType_HalfedgeWalker, feature_angle: float): bool =
...
proc calc_edge_vector*(halfedge: MyMeshType_HalfedgeWalker): auto =
...
proc calc_edge_vector*(edge: MyMeshType_EdgeWalker): auto =
  ## Calculates the edge vector as the difference of the
  ## the points defined by to_vertex_handle and from_vertex_handle
  edge.goHalfedge.calc_edge_vector
    
proc calc_edge_sqr_length*(halfedge: MyMeshType_HalfedgeWalker): auto =
  let v = halfedge.calc_edge_vector
  return dot(v,v)

proc calc_edge_sqr_length*(edge: MyMeshType_EdgeWalker): auto =
  edge.goHalfedge.calc_edge_sqr_length
  
proc calc_edge_length*(halfedge: MyMeshType_HalfedgeWalker): auto =
  halfedge.calc_edge_sqr_length.sqrt
  
proc calc_edge_length*(edge: MyMeshType_EdgeWalker): auto =
  edge.goHalfedge.calc_edge_length

proc calc_sector_vectors*(halfedge: MyMeshType_HalfedgeWalker) : tuple[vec0, vec1: type(halfedge.goToVertex.propPoint)] =
...
proc calc_sector_normal_unnormalized*(halfedge: MyMeshType_HalfedgeWalker) : type(halfedge.goToVertex.propPoint) =
...
proc calc_dihedral_angle*(halfedge: MyMeshType_HalfedgeWalker) : type(halfedge.goToVertex.propPoint[0]) =
...
proc calc_dihedral_angle_fast*(halfedge: MyMeshType_HalfedgeWalker): type(halfedge.goToVertex.propPoint[0]) =
...
proc calc_face_centroid*(face: MyMeshType_FaceWalker): type(face.goHalfedge.goToVertex.propPoint) =
...
proc calc_halfedge_normal*(inHalfedge: MyMeshType_HalfedgeWalker, feature_angle: float64): type(inHalfedge.goToVertex.propPoint) =
...
proc calc_sector_angle*(halfedge: MyMeshType_HalfedgeWalker): type(halfedge.goToVertex.propPoint[0]) =
...
proc calc_sector_area*(halfedge: MyMeshType_HalfedgeWalker): type(halfedge.goToVertex.propPoint[0]) =
...
proc calc_vertex_normal_fast*(vertex: MyMeshType_VertexWalker): type(vertex.propPoint) =
  for face in vertex.circulateFaces:
    result = result + face.getNormal

proc calc_vertex_normal*(vertex: MyMeshType_VertexWalker): type(vertex.propPoint) =
...
proc calc_vertex_normal_loop*(vertex: MyMeshType_VertexWalker): type(vertex.propPoint) =
...
proc calc_vertex_normal_correct*(vertex: MyMeshType_VertexWalker): type(vertex.propPoint) =
